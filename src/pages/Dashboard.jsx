            ...
            <main className="main" style={{ flex: 1, padding: '20px', overflowY: 'auto', marginLeft: sidebarOpen ? "260px" : "0px", transition: "margin-left 0.3s ease" }}>
                ...
                <section style={{
                    ...
                    {[
                        ...
                        { icon: <CheckCircle size={18} />, label: 'LLAMADAS DE CALIDAD', value: kpi?.efectivas ?? '-' },
                        filters.tipo_llamada?.toLowerCase() !== 'servicio' && { icon: <DollarSign size={18} />, label: 'VENTAS CERRADAS', value: kpi?.ventas ?? '-' },
