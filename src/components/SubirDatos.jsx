...
const BASE = "https://cltiene-backend-293865702055.us-central1.run.app";
...
const SubirDatos = () => {
    ...
    useEffect(() => {
        ...
        const id = setInterval(async () => {
            const res = await fetch(`${BASE}/api/upload/estado`);
    ...
    const iniciar = async () => {
        ...
        setPolling(true);
        await fetch(`${BASE}/api/upload/iniciar`, { method: 'POST' });
    };
