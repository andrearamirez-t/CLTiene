...
- 🔴 **Solo envía SALIENTES, no ENTRADA** ("no sabe cómo se descargaba el otro") → **las llamadas de entrada de agosto se están perdiendo** (no llegan a SQL ni al dashboard). **Acción:** capacitar a Steven para bajar también el export de entrada, o automatizar desde ContactVox.
