...
def generar_reporte_completo(filters: FilterModel):
    content, error = call(
        prompt_html(
            ...
            "esos bullets + la conclusión; PROHIBIDO incluir aquí el desglose del estatus del marcador "
            ...
            "3. Estatus de Llamadas y Contacto Efectivo — (a) estatus del marcador "
            "(Contestada/No Contestada/Ocupada con %); (b) el desglose de CONTACTO EFECTIVO del contexto "
            "(Contactado = se habló con la persona vs Sin Contacto = buzón/no disponible/no se habló, con "
            "número y %) — esto responde 'de las llamadas, en cuántas se habló con la persona vs no'. "
            "Incluye aquí la Nota metodológica sobre 'contestada'.\n"
            "4. Productividad por Asesor — tabla ordenada por volumen: Asesor | Llamadas | TMO | "
            "Contactado | Sin Contacto | Saludos | Posibles ventas (usa los valores 'Contactado' y "
            "'Sin Contacto' del contexto por asesor — es el contacto EFECTIVO, no el % de calidad). "
