...
def generar_reporte_completo(filters: FilterModel):
    content, error = call(
        prompt_html(
            ...
            "2) Contactabilidad, 3) TMO, 4) Participación cliente, 5) Saludo, 6) Calidad, "
            "7) Posibles ventas. Para 'Saludo' y 'Calidad' usa los valores de 'VALORES PARA EL TABLERO' "
            "del contexto (Saludo = el conteo; Calidad = el score 'X/100'); NUNCA pongas 'N/A'. Los "
            "semáforos de las 7 filas vienen en 'SEMÁFOROS YA CALCULADOS' — cópialos EXACTO.\n"
