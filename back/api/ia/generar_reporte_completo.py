...
def generar_reporte_completo(filters: FilterModel):
    content, error = call(
        prompt_html(
            ...
            "CONTEOS de detecciones, NO juicios de calidad. NO interpretes automáticamente un conteo alto "
            "como malo ni uno bajo como bueno. NO afirmes cosas como 'la despedida muestra exceso de "
            "esfuerzo' o 'falta de cierre adecuado' si el contexto no da una métrica explícita que lo "
            "sustente. Un conteo alto de despedidas (ej. 203) normalmente es BUENO (hubo cierre). Analiza "
            "en proporción al universo cuando sea posible; si no, solo reporta el número sin juicio.\n"
            ...
            "(sería contradictorio: 'reducir de 1:11 a 1:25' está mal, 1:25 es mayor). En "
            "recomendaciones NO propongas 'aumentar el tiempo por aumentar el tiempo'; el objetivo es "
            "'desarrollar mejor la conversación y explorar necesidades, evitando cierres prematuros, "
            "SIN extender artificialmente la duración'.\n"
            ...
            "'SEMÁFOROS YA CALCULADOS' — cópialos EXACTO.\n"
